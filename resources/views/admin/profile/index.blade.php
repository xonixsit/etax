...
<div class="container mx-auto px-4 py-6">
    <div class="bg-slate-800/60 backdrop-blur-md rounded-xl shadow-2xl border border-slate-700/50 p-6" role="main" aria-labelledby="profile-settings-title">
        <!-- Header -->
        <div class="mb-6 flex items-center gap-3" aria-labelledby="profile-settings-title" aria-describedby="profile-settings-description">
    <!-- Icon -->
    ...
    <div class="flex flex-col">
        ...
        <p id="profile-settings-description" class="mt-1 text-sm text-gray-400">Manage your account information and preferences</p>
    </div>
</div>

        @if (session('success'))
        <div class="mb-6 p-4 bg-green-500/10 border border-green-500/20 rounded-lg" role="alert" aria-live="polite">
            <div class="flex">
        ...
        <!-- Profile Form -->
        <form action="{{ route('admin.profile.update') }}" method="POST" class="space-y-6" aria-labelledby="profile-form-title">
            @csrf
            @method('PUT')

            <!-- Personal Information Section -->
            <div class="space-y-4">
                <h2 id="personal-info-title" class="text-lg font-medium text-gray-100 border-b border-gray-700 pb-2">Personal Information</h2>
