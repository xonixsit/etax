...
<head>
    ...
    <title>Admin Registration - Employee Assessment Platform</title>
    ...
    <main class="w-full max-w-md">
        <div class="bg-slate-800/60 backdrop-blur-md shadow-2xl rounded-xl p-8 md:p-10">
            <div class="text-center mb-8">
                ...
                <h1 class="mt-4 text-3xl font-bold tracking-tight text-gray-100 sm:text-4xl">Create Admin Account</h1>
                <p class="mt-2 text-sm text-gray-400">Register for the Employee Assessment Platform</p>
            </div>
            ...
            <p class="mt-6 text-center text-sm text-gray-400">
                ...
                <a href="{{ route('admin.login') }}" class="font-semibold text-indigo-400 hover:text-indigo-300">Sign in</a>
            </p>
