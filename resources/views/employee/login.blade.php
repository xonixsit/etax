    ...
    <main class="w-full max-w-md">
        <div class="bg-slate-800/60 backdrop-blur-md shadow-2xl rounded-xl p-8 md:p-10">
            <div class="text-center mb-8">
                ...
                <h1 class="mt-4 text-3xl font-bold tracking-tight text-gray-100 sm:text-4xl">Employee Portal</h1>
                <p class="mt-2 text-sm text-gray-400">Access your assessment platform</p>
            </div>
